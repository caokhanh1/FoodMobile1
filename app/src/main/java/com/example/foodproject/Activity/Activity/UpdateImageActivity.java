        ...
        if (imageUri != null) {
            ...
            fileReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            firebaseUser.updateProfile(profileChangeRequest).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(UpdateImageActivity.this, "Update success", Toast.LENGTH_LONG).show();
                                        Intent intent = new Intent(UpdateImageActivity.this, UserProfileActivity.class);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(UpdateImageActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        } else {
            Toast.makeText(UpdateImageActivity.this, "NO FILE SELECTED", Toast.LENGTH_LONG).show();
        }
    }
